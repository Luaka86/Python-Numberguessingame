...
def start_game():
    ...
    print('Hello traveler! Welcoe to the game of guesses!')
    player_name = input("What is your name?")
    wanna_play = input(f'Hi, {player_name}, would you like to play'
                       f'the guessing game? Enter Yes/No: ') 

    if wanna_play.lower() != 'yes' :
        print ('That\s cool, Thank!')
        exit()
    ...
    while wanna_play.lower() == 'yes' :
        try:
            guess = int(input("Pic a number between 1 and 10: "))
